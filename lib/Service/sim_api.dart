  ...
  /// Model click khi làm bài
  class SimClick {
    final int idTinhHuong;
    final double thoiDiemNhan;

    SimClick({required this.idTinhHuong, required this.thoiDiemNhan});

    Map<String, dynamic> toJson() => {
      'IdTinhHuong': idTinhHuong,
      'ThoiDiemNhan': thoiDiemNhan,
    };
  }
